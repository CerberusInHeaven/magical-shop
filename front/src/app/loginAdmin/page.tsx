  ...
  return (
    <main className="max-w-screen-xl flex flex-col items-center mx-auto p-6">
      ...
      <div className="max-w-sm">
        <h1 className="text-3xl font-bold my-8 text-white">A passagem aonde apenas o mestre tem conhecimento</h1>
        <form className="max-w-sm mx-auto"
          ...
          <button type="submit" className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-blue-800">Entrar</button>
        </form>
      </div>
    </main>
  );
